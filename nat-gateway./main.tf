...
# associate private data subnet az3 with private route table az3
resource "aws_route_table_association" "private_data_subnet_az3_route_table_az3_association" {
  subnet_id         = var.private_data_subnet_az3_id
  route_table_id    = aws_route_table.private_route_table_az3.id
}
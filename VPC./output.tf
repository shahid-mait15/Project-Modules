...
#------------------------------------------------------------------------
output "vpc_id" {value = aws_vpc.gxi_vpc.id}
...
output "public_subnet_az3_id" {value = aws_subnet.public_subnet_az3.id}
...
output "private_app_subnet_az3_id" {value = aws_subnet.private_app_subnet_az3.id}
...
output "private_data_subnet_az3_id" {value = aws_subnet.private_data_subnet_az3.id}

#---------------------------------------------------------------------------------
output "internet_gateway" {value = aws_internet_gateway.igw}